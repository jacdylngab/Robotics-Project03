...
def generate_heatmap():
    ...
    # Scan for obstacles
    data = scan()
    obstacles_data = scanned_points(data, goal, width, height) # All the data including the angle so (y,x) and the angle
    obstacles = [obstacle[0] for obstacle in obstacles_data] 
    if not obstacles:
